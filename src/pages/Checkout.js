    ...
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
            ...
            <form className='bg-white px-5 mt-12' noValidate onSubmit={handleSubmit((data)=>{
              ...
              <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-2xl py-12 font-semibold leading-7 text-gray-900">Personal Information</h2>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-600">
                    ...
                    <ul role="list" className="divide-y divide-gray-100">
                      {user.addresses && user.addresses.map((address, index) => (
                          <li key={index} className="flex justify-between gap-x-6 py-5 my-3 border-solid border-2 border-gray-200 p-5">
                          <div className="flex gap-x-4">
                            ...
                            <div className="min-w-0 flex-auto">
                              ...
                              <p className="mt-1 truncate text-xs leading-5 text-gray-500"> {address.street}, {address.city}, {address.state}, {address.pincode}</p>
                            </div>
                          </div>
                          <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                            ...
                            {address.state ? (
                              <p className="mt-1 text-xs leading-5 text-gray-500">
                                Mobile number: <time dateTime={address.city}> {address.phone}</time>
                              </p>
                            ) : (
                  ...
                  <div className="mt-10 space-y-10">
                    <fieldset>
                      <legend className="text-sm font-semibold leading-6 text-gray-900">Payment Notifications</legend>
          ...
          <div className="lg:col-span-2 mx-auto mt-0 bg-white max-w-7xl px-0 sm:px-0 lg:px-0">
