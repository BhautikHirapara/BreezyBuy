    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                ...
                <p className="mt-1 text-sm leading-6 text-gray-600">
                  ...
                  <ul role="list" className="divide-y divide-gray-100">
                    {addresses.map((address) => (
                        <li key={address.email} className="flex justify-between gap-x-6 py-5 border-solid border-2 border-gray-200 p-5">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mt-border-t border-gray-200 px-4 py-6 sm:px-68">
            <h1 className="text-3xl my-6 font-bold tracking-tight text-gray-900">
              Cart 
            </h1>
                  ...
                  <li key={product.id} className="flex py-6">
                    ...
                    <div className="ml-4 flex flex-1 flex-col">
                      ...
                      <div className="flex flex-1 items-end justify-between text-sm">
                        <p className="text-gray-500 mr-5">Qty 
